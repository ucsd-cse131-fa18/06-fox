...
module Language.Fox.Runner where
...
import Language.Fox.Types  hiding     (Program, Result)
import Language.Fox.Parser
import Language.Fox.Compiler
...
--------------------------------------------------------------------------------
runHeap :: Int -> FilePath -> Program -> IO Result
--------------------------------------------------------------------------------
runHeap n = runMb (Just n)

--------------------------------------------------------------------------------
runMb :: Maybe Int -> FilePath -> Program -> IO Result
--------------------------------------------------------------------------------
runMb heapMb name pgm = do
